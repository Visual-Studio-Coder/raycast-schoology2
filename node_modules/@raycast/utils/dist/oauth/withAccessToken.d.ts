 ...
 */
export declare function withAccessToken<T>(options: WithAccessTokenParameters): <U extends (() => Promise<void> | void) | React.ComponentType<T>>(fnOrComponent: U) => U extends () => Promise<void> | void ? Promise<void> : React.FunctionComponent<T>;
/**
