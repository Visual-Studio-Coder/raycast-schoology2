...
${indent}`);
  ...
  var import_javascript_stringify = __toModule(require_dist());
  ...
  var QuickChart = class {
    ...
    getShortUrl() {
      return __async(this, null, function* () {
        ...
        const resp = yield postJson(`${this.getBaseUrl()}/chart/create`, this.getPostData());
        if (!resp.ok) {
...
${quickchartError}` : "";
    ...
    toBinary() {
      return __async(this, null, function* () {
        ...
        const resp = yield postJson(`${this.getBaseUrl()}/chart`, this.getPostData());
        if (!resp.ok) {
          const quickchartError = resp.headers.get("x-quickchart-error");
          const details = quickchartError ? `
${quickchartError}` : "";
