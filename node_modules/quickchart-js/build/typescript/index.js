...
function doStringify(chartConfig) {
    var str = (0, javascript_stringify_1.stringify)(chartConfig);
    if (!str) {
        return undefined;
    }
...
var QuickChart = /** @class */ (function () {
    ...
    QuickChart.prototype.setHost = function (host) {
        this.host = host;
        return this;
    };
    QuickChart.prototype.setScheme = function (scheme) {
        this.scheme = scheme;
        return this;
    };
    ...
    QuickChart.prototype.getBaseUrl = function () {
    ...
    QuickChart.prototype.getUrlObject = function () {
        ...
        var ret = new URL("".concat(this.getBaseUrl(), "/chart"));
    ...
    QuickChart.prototype.getShortUrl = function () {
        return __awaiter(this, void 0, void 0, function () {
            var resp, quickchartError, details, json;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, postJson("".concat(this.getBaseUrl(), "/chart/create"), this.getPostData())];
                    case 1:
                        resp = _a.sent();
                        if (!resp.ok) {
                            quickchartError = resp.headers.get('x-quickchart-error');
                            details = quickchartError ? "\n".concat(quickchartError) : '';
                            throw new Error("Chart shorturl creation failed with status code ".concat(resp.status).concat(details));
                        }
    ...
    QuickChart.prototype.toBinary = function () {
        return __awaiter(this, void 0, void 0, function () {
            var resp, quickchartError, details, data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!this.isValid()) {
                        ...
                        return [4 /*yield*/, postJson("".concat(this.getBaseUrl(), "/chart"), this.getPostData())];
                    case 1:
                        resp = _a.sent();
                        if (!resp.ok) {
                            quickchartError = resp.headers.get('x-quickchart-error');
                            details = quickchartError ? "\n".concat(quickchartError) : '';
                            throw new Error("Chart creation failed with status code ".concat(resp.status).concat(details));
                        }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, "data:image/".concat(type, ";base64,").concat(b64buf)];
                }
            });
        });
    };
    ...
    QuickChart.getGradientFillHelper = function (direction, colors, dimensions) {
        return "__BEGINFUNCTION__getGradientFillHelper(".concat(JSON.stringify(direction), ", ").concat(JSON.stringify(colors), ", ").concat(JSON.stringify(dimensions), ")__ENDFUNCTION__");
    };
    QuickChart.getGradientFill = function (colorOptions, linearGradient) {
        return "__BEGINFUNCTION__getGradientFill(".concat(JSON.stringify(colorOptions), ", ").concat(JSON.stringify(linearGradient), ")__ENDFUNCTION__");
    };
    QuickChart.getImageFill = function (url) {
        return "__BEGINFUNCTION__getImageFill(".concat(JSON.stringify(url), ")__ENDFUNCTION__");
    };
    QuickChart.pattern = {
        draw: function (shapeType, backgroundColor, patternColor, requestedSize) {
            return "__BEGINFUNCTION__pattern.draw(".concat(JSON.stringify(shapeType), ", ").concat(JSON.stringify(backgroundColor), ", ").concat(JSON.stringify(patternColor), ", ").concat(JSON.stringify(requestedSize), ")__ENDFUNCTION__");
        }
    };
    return QuickChart;
}());
